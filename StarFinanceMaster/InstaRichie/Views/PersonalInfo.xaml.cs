...
namespace StartFinance.Views
{
    ...
    public sealed partial class PersonalInfo : Page
    {
            ...
            try
            {
                ...
                {   // Inserts the data
                    conn.Insert(new PersonalInfoDB()
                    {
                        ...
                        DateOfBirth = DOBTxtBx.Text,
                        Gender = GenderTxtBx.Text,
                        EmailAdress = EmailTxtBx.Text,
        ...
        private void PersonalInfoView1_ItemClick(object sender, ItemClickEventArgs e)
        {
            ...
            DOBTxtBxUpdate.Text = ((PersonalInfoDB)e.ClickedItem).DateOfBirth;
            GenderTxtBxUpdate.Text = ((PersonalInfoDB)e.ClickedItem).Gender;
            EmailTxtBxUpdate.Text = ((PersonalInfoDB)e.ClickedItem).EmailAdress;
            PhoneNumberTxtBxUpdate.Text = ((PersonalInfoDB)e.ClickedItem).PhoneNumber;
        }
        ...
        private async void AppBarButton_Click(object sender, RoutedEventArgs e)
        {
            try
            {
                ...
                var query1 = conn.Query<PersonalInfoDB>($"Update PersonalInfoDB set FirstName= '{FirstNameTxtBxUpdate.Text}', LastName = '{LastNameTxtBxUpdate.Text}', DateOfBirth='{DOBTxtBxUpdate.Text}', Gender='{GenderTxtBxUpdate.Text}', EmailAdress='{EmailTxtBxUpdate.Text}', PhoneNumber='{PhoneNumberTxtBxUpdate.Text}' WHERE PersonalID= '{PersonaalIDLabel}'");
                Results();
            }
            catch(NullReferenceException)
            {
